...
{
    public partial class ActivateVisaFrm : DevExpress.XtraEditors.XtraForm
    {
        DataSources.Linq.dsTeachersUnionViewsDataContext dsLinq = new DataSources.Linq.dsTeachersUnionViewsDataContext();

        public ActivateVisaFrm()
        {
            InitializeComponent();
            LoadData();
        }
        ...
        private void repositoryItemButtonEditTransferSave_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            try
            {
                SQLProvider.UpdateVisaActivation(row.GetMemberValue("Activate"), row.GetMemberValue("ActivateDate"), row.GetMemberValue("MMashatId"));
