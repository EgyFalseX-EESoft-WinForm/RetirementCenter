...
namespace RetirementCenter.Forms.Data
{
    public partial class TBLHafezSarfEditFrm : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                adp.Update(Convert.ToInt32(tbcountmembers.EditValue), Convert.ToInt32(tbcountwarasa.EditValue), Convert.ToDouble(tbhafezmembers.EditValue), Convert.ToDouble(tbhafezwarasa.EditValue)
                    ...
                    , Convert.ToInt32(lueSyndicateId.EditValue), Convert.ToInt32(lueDofatSarfId.EditValue));
