...
{
    public partial class Qry38dFrm : DevExpress.XtraEditors.XtraForm
    {
        #region -   Functions   -
        public Qry38dFrm()
        {
        ...
        private void Qry06Frm_Load(object sender, EventArgs e)
        {
            if (!PrepareNewId())
                return;
            // TODO: This line of code loads data into the 'dsQueries.vQry38d' table. You can move, or remove it, as needed.
            this.vQry38dTableAdapter.Fill(this.dsQueries.vQry38d);
        ...
        private void btnSaveBackData_Click(object sender, EventArgs e)
        {
            ...
            System.Threading.ThreadPool.QueueUserWorkItem((o) => 
            {
                ...
                try
                {
                    ...
                    {
                        RetirementCenter.DataSources.dsQueries.vQry38dRow row = (RetirementCenter.DataSources.dsQueries.vQry38dRow)((DataRowView)gridViewData.GetRow(i)).Row;
