...
{
    public partial class Qry101Frm : DevExpress.XtraEditors.XtraForm
    {
        #region -   Functions   -
        public Qry101Frm()
        {
            InitializeComponent();
            SQLProvider.SetAllCommandTimeouts(sp_001TableAdapter, 0);
        }
        #endregion
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            if (!dxvp.Validate())
                return;
            sp_001TableAdapter.Fill(dsQueries.sp_001, ccbeDof.EditValue.ToString(), ccbeSarfType.EditValue.ToString());
