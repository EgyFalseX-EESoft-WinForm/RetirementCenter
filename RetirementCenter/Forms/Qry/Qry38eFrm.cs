...
{
    public partial class Qry38eFrm : DevExpress.XtraEditors.XtraForm
    {
        #region -   Functions   -
        public Qry38eFrm()
        {
        ...
        private void Qry06Frm_Load(object sender, EventArgs e)
        {
            ...
            if (!PrepareNewId())
                return;
            // TODO: This line of code loads data into the 'dsQueries.vQry38e' table. You can move, or remove it, as needed.
            this.vQry38eTableAdapter.Fill(this.dsQueries.vQry38e);
        ...
        private void btnSaveBackData_Click(object sender, EventArgs e)
        {
            ...
            System.Threading.ThreadPool.QueueUserWorkItem((o) => 
            {
                ...
                try
                {
                    ...
                    {
                        RetirementCenter.DataSources.dsQueries.vQry38eRow row = (RetirementCenter.DataSources.dsQueries.vQry38eRow)((DataRowView)gridViewData.GetRow(i)).Row;
