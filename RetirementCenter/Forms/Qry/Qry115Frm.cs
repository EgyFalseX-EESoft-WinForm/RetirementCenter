...
{
    public partial class Qry115Frm : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            InitializeComponent();
            SQLProvider.SetAllCommandTimeouts(vQry115TableAdapter, 0);
        }
        #endregion
        ...
        {
            vQry115TableAdapter.Fill(dsQueries.vQry115, Convert.ToInt32(LueFilter.EditValue));
        }
        #endregion
    }
}
