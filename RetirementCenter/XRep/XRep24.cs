...
{
    public partial class XRep24 : DevExpress.XtraReports.UI.XtraReport
    {
        public XRep24(DataSources.dsReports.Rep24_ADataTable tbl)
        {
            InitializeComponent();
            LoadDataSource(tbl);
            //SQLProvider.SetAllCommandTimeouts(rep19_BTableAdapter, 0);
        }
        private void LoadDataSource(DataSources.dsReports.Rep24_ADataTable tbl)
        {
